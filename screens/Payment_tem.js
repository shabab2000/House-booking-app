...
export default function Payment_tem({route,navigation}) {
...
console.log(books);
      ...
      const handlePress =  async () => {
        try{
          ...
          fetch('https://app.rthouse.ml/payment_tem.php', {
            method: 'POST',
            body: formData,  
            headers: {
...
/>
            ...
            <View style={{paddingTop:20,justifyContent: 'center',paddingLeft:50}}>
                ...
                <Text style={{fontSize:18,fontFamily:'Kanits'}}>ค่าห้อง : {books.price}฿/{books.time}ชั่วโมง</Text>
                <Text style={{fontSize:18,fontFamily:'Kanits'}}>จำนวนชั่วโมง : {books.time}</Text>
                <Text style={{fontSize:18,fontFamily:'Kanits'}}>เวลาออก : {route.params.out}</Text>
                <Text style={{fontSize:18,fontFamily:'Kanits',textDecorationLine: 'underline'}}>จำนวนเงินที่ต้องชำระ  {books.price} ฿</Text>
            </View>
