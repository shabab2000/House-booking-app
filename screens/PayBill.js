...
export default function PayBill({route,navigation}) {
    ...
    const pickImage = async () => {
      ...
      const handlePress =  async () => {
        try{
          ...
          formData.append('idb',route.params.idb)
          formData.append('idh',route.params.idh)
          formData.append('id_bill',route.params.id)
          fetch('https://app.rthouse.ml/paybill.php', {
            method: 'POST',
            body: formData,  
            headers: {
...
/>
            ...
            <View style={{paddingTop:20,justifyContent: 'center',paddingLeft:50}}>
                ...
                <Text style={{fontSize:18,fontFamily:'Kanits',textDecorationLine: 'underline'}}>ยอดเงินที่ต้องชำระ : {route.params.total}฿</Text>
            </View>
