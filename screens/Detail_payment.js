...
export default function Detail_payment({route,navigation}) {
...
const load  = async() =>{
    ...
    fetch('https://app.rthouse.ml/listpay.php?uid='+uid+'&idb='+route.params.idb)
...
<ScrollView showsVerticalScrollIndicator={false}>
 <View>
        ...
        <Text style={{textAlign:'center',fontFamily:'Kanits',fontSize:18,}}> จำนวนเงิน {house.total}฿</Text>
        <Text style={{textAlign:'center',fontFamily:'Kanits',fontSize:18,}}> วันที่ชำระเงิน {house.duedate}</Text>
