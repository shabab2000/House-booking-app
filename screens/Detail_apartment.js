...
export default function Detail_apartment({route,navigation}) {
 ...
 const load  =()=> {
    ...
    fetch('https://app.rthouse.ml/slide_apartment.php?id='+route.params.id_img)
...
<Appbar.Content title="รายละเอียดอพาร์ทเม้นท์" color="white" />
</Appbar.Header>
        ...
        <View style={{padding:7}}>
            ...
            <Text style={{fontSize:18,fontFamily:'Kanits',paddingLeft:10,}}>มี {route.params.bedroom} ห้องนอน / {route.params.bathroom} ห้องน้ำ</Text>
            <Text style={{fontSize:18,fontFamily:'Kanits',textAlign: 'center'}}>ค่าเช่า {route.params.price} บาท/เดือน</Text>
            <View style={{paddingTop:20}}>
                ...
                <View style={{paddingLeft:20,paddingTop:20}}>
                    <Text style={{fontSize:16,fontFamily:'Kanits'}}>กฎของห้อง</Text>
                    <Text style={{fontSize:16,fontFamily:'Kanits',paddingLeft:15}}>{route.params.rule}</Text>
                </View>
                <View style={{paddingLeft:20,paddingTop:15}}>
                    <Text style={{fontSize:16,fontFamily:'Kanits'}}>ความอำนวยสะดวก</Text>
                    <Text style={{fontSize:16,fontFamily:'Kanits',paddingLeft:15}}>{route.params.facility}</Text>
                </View>
                <View style={{paddingLeft:20,paddingTop:15}}>
        ...
        <View style={{display: 'flex',flexDirection: 'row',justifyContent: 'center'}}>
                    ...
                    <TouchableOpacity style={{backgroundColor:'#749d63',}} onPress={() => route.params.status == 'ไม่ว่าง'? Alert.alert('ขออภัยค่ะ!','ห้องพักนี้ไม่ว่างให้เปิดเช่าในขณะนี้'): navigation.navigate('Booking',{id: route.params.id, price: route.params.price, deposit: route.params.deposit, name: route.params.name,})}>
                        <Text style={{fontSize:20,fontFamily:'Kanits',paddingLeft:40,paddingRight:40,paddingTop:20,paddingBottom:20}}>เปิดจอง</Text>
                    </TouchableOpacity>
