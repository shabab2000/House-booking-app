...
export default function Temporary_details({route,navigation}) {
...
<Appbar.Content title="รายละเอียดห้องเช่า" color="white" />
        ...
        <View style={{padding:7}}>
            ...
            <Text style={{fontSize:18,fontFamily:'Kanits',textAlign: 'center'}}>ค่าเช่า {route.params.price} บาท/3ชั่วโมง</Text>
            <View style={{paddingTop:20}}>
        ...
        <View style={{display: 'flex',flexDirection: 'row',justifyContent: 'center'}}>
                    ...
                    <TouchableOpacity style={{backgroundColor:'#749d63',}} onPress={() => route.params.status == 'ไม่ว่าง'? Alert.alert('ขออภัยค่ะ!','ห้องพักนี้ไม่ว่างให้เปิดเช่าในขณะนี้'): navigation.navigate('Book_temporary',{id: route.params.id, price: route.params.price, deposit: route.params.deposit, name: route.params.name,})}>
