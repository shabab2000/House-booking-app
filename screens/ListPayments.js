...
export default function ListPayments({route,navigation}) {
...
<FlatList 
              ...
              renderItem={({key,item}) =>
<ListItem key={key}  bottomDivider topDivider onPress={() => navigation.navigate('Detail_payment',{id:item.id, idh:item.idh, name:item.name, idb:item.idb})}>
